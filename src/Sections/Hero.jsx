    ...
    <section className="relative  w-full bg-black overflow-hidden flex flex-col items-center">
      ...
      <div className="relative z-10 flex flex-col items-center pt-10  px-4">
        ...
        <img
          src={logo}
          alt="FoodIt Logo"
          className="w-21 md:w-40 h-auto object-contain mb-3"
        />

        {/* ব্যাজ ইমেজ */}
        <img
          src={badge}
          alt="100% Natural Badge"
          className="w-[72%] max-w-[310px] h-auto object-contain"
        />

        <img src={Text01} alt="text-1"
          className='mt-7 mb-4 w-77' />
