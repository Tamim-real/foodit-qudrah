...
const QNA = () => {
    ...
    const faqData = [
        ...
        },
        {
            ...
            answer: "QUDRAH প্রাকৃতিক উপাদান দিয়ে তৈরি করা হয়েছে যা নিয়ম অনুযায়ী খেলে শরীরের ভেতর থেকে শক্তি, স্ট্যামিনা ও পারফরম্যান্স উন্নত করতে সহায়তা করবে। নিয়মিত ৩-৪ মাস ব্যবহার করলে ভালো ও দীর্ঘমেয়াদি উন্নতি পাবেন ইনশাআল্লাহ।"
        },
        {
